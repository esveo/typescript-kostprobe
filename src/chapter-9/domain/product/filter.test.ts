...
const testData: Product[] = [
  createProduct("Prod 1", "Description", 1, "ELECTRONICS"),
  createProduct("Prod 2", "Description", 2, "ELECTRONICS"),
  createProduct("Prod 3", "Description", 3, "FOOD"),
  createProduct("Prod 4", "Description", 4, "PARTY_SUPPLIES"),
];
